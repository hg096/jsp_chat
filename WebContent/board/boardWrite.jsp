...
<script type="text/javascript">
	...
	function passwordCheckFunction(){
		...
		if(userPassword1 != userPassword2){
			$('#passwordCheckMessage').html('동일한 비밀번호를 입력해주세요');
		} else {
		...
		<form method="post" action="../boardWrite" enctype="multipart/form-data">
			<table class="table table-bordered table-hover"
				...
				<tbody>
					...
					<tr>
						<td style="width: 100px;"><h5>이미지 업로드</h5></td>
						...
						<div class="input-group col-xs-8" style="margin: auto;">
							...
							<span class="input-group-btn">
								<button type="button" class="browse btn btn-primary input-lg">찾기&nbsp;<i class="glyphicon glyphicon-search"></i></button>
							</span>
						</div>
					</tr>
					<tr>
					<td style="text-align: left;" colspan="3"><h5 style="color: red;" id="passwordCheckMessage"></h5><button class="btn btn-primary pull-right" type="submit" name="submit">확인</button></td>
					</tr>
				</tbody>
			</table>
		</form>
