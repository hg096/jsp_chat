			...
			>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<input class="form-control" type="text" maxlength="50" name="boardTitle"
								placeholder="Title" value="<%=board.getBoardTitle()%>"
							>
						</td>
					</tr>
					<tr>
						...
						<td>
							<textarea class="form-control" rows="10" name="boardContent" maxlength="2048"
								placeholder="Content"
							><%=board.getBoardContent()%></textarea>
						</td>
					</tr>
					<tr>
						<td style="width: 100px;">
						...
						<td colspan="2">
							...
							<div class="input-group col-xs-8" style="margin: auto;">
								...
								<input type="text" class="form-control input-lg" disabled
									placeholder="<%=board.getBoardFile()%>"
								>
					...
					<tr>
						<td style="text-align: left;" colspan="3">
							...
							<button class="btn btn-primary pull-right" type="submit" name="submit">수정완료</button>
						</td>
					</tr>
				</tbody>
			</table>
